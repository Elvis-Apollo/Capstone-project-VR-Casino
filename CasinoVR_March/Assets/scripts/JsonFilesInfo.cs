...
public static class JsonFilesInfo
{
    public static Dictionary<string, string> SlotMachine_Json_FilePaths = new Dictionary<string, string>() {
        ...
        {"SlotMachine_4", "Assets/scripts/Json_files/SlotMachine_4.json"},
        {"SlotMachine_5", "Assets/scripts/Json_files/SlotMachine_5.json"},
        {"SlotMachine_6", "Assets/scripts/Json_files/SlotMachine_6.json"},
        {"SlotMachine_7", "Assets/scripts/Json_files/SlotMachine_7.json"},
